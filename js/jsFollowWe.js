...
const normalToolbar        = document.getElementById('weNormalToolbar');
const followUpToolbar      = document.getElementById('weFollowUpToolbar');
const followUpMessageBox   = document.getElementById('weFollowUpMessageBox');
const filterNamaInput      = document.getElementById('weFilterNama');
