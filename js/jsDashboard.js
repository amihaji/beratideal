...
const MENU_ACCESS_MAP = [
    ...
    { page: 'referral', navId: 'nav-referral', accessKey: 'aksesReferral' },
...
function buildNormalizedAccess(source = {}) {
    ...
    return {
        ...
        aksesReferral: normalizeAccessValue(source.aksesReferral ?? source.aksesreferral ?? source.aksesReferall ?? source.aksesreferall ?? source.referral),
...
function getStoredAccess() {
    ...
    return buildNormalizedAccess({
        ...
        aksesReferral: parsedAccess.aksesReferral || rawAccess.aksesReferral || rawAccess.aksesReferall || localStorage.getItem('aksesReferral'),
