...
function buildNormalizedAccess(source = {}) {
    ...
    return {
        ...
        aksesReferral: normalizeAccessValue(source.aksesReferral ?? source.aksesreferral ?? source.referral),
...
function getStoredAccess() {
    ...
    return buildNormalizedAccess({
        ...
        aksesReferral: parsedAccess.aksesReferral || rawAccess.aksesReferral || localStorage.getItem('aksesReferral'),
